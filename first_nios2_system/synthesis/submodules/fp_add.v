...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_altfp_add_sub_50k
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fp_add_altfp_add_sub_50k
//VALID FILE
...
module fp_add (
	...
	fp_add_altfp_add_sub_50k	fp_add_altfp_add_sub_50k_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_add.inc TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_add.cmp TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_add.bsf TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_add_inst.v TRUE
