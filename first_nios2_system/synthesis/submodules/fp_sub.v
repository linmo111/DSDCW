...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_sub_altfp_add_sub_61k
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fp_sub_altfp_add_sub_61k
//VALID FILE
...
module fp_sub (
	...
	fp_sub_altfp_add_sub_61k	fp_sub_altfp_add_sub_61k_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_sub.inc TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_sub.cmp TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_sub.bsf TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_sub_inst.v TRUE
