...
module  fp_subtractor_altbarrel_shift_ltd
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fp_subtractor_altbarrel_shift_ltd
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_subtractor_altbarrel_shift_aeb
	( 
	data,
	distance,
	result) ;
	...
	assign
		...
		sel_w = {distance[4:0]},
		smux_w = {((({26{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104])), ((({26{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78])), ((({26{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), ((({26{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26])), ((({26{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0]))};
endmodule //fp_subtractor_altbarrel_shift_aeb
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_subtractor_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //fp_subtractor_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_subtractor_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	fp_subtractor_altpriority_encoder_3e8   altpriority_encoder13
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder13_q),
	.zero(wire_altpriority_encoder13_zero));
	fp_subtractor_altpriority_encoder_3e8   altpriority_encoder14
	( 
	.data(data[3:2]),
...
endmodule //fp_subtractor_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_subtractor_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	fp_subtractor_altpriority_encoder_6e8   altpriority_encoder11
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder11_q),
	.zero(wire_altpriority_encoder11_zero));
	fp_subtractor_altpriority_encoder_6e8   altpriority_encoder12
	( 
	.data(data[7:4]),
...
endmodule //fp_subtractor_altpriority_encoder_be8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_subtractor_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //fp_subtractor_altpriority_encoder_3v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_subtractor_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	fp_subtractor_altpriority_encoder_3v7   altpriority_encoder17
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder17_q));
	fp_subtractor_altpriority_encoder_3e8   altpriority_encoder18
	( 
	.data(data[3:2]),
...
endmodule //fp_subtractor_altpriority_encoder_6v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_subtractor_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	fp_subtractor_altpriority_encoder_6v7   altpriority_encoder15
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder15_q));
	fp_subtractor_altpriority_encoder_6e8   altpriority_encoder16
	( 
	.data(data[7:4]),
...
endmodule //fp_subtractor_altpriority_encoder_bv7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_subtractor_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	fp_subtractor_altpriority_encoder_be8   altpriority_encoder10
	( 
	.data(data[15:8]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	fp_subtractor_altpriority_encoder_bv7   altpriority_encoder9
	( 
	.data(data[7:0]),
...
endmodule //fp_subtractor_altpriority_encoder_r08
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_subtractor_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	fp_subtractor_altpriority_encoder_be8   altpriority_encoder19
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder19_q),
	.zero(wire_altpriority_encoder19_zero));
	fp_subtractor_altpriority_encoder_be8   altpriority_encoder20
	( 
	.data(data[15:8]),
...
endmodule //fp_subtractor_altpriority_encoder_rf8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_subtractor_altpriority_encoder_qb6
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	fp_subtractor_altpriority_encoder_r08   altpriority_encoder7
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder7_q));
	fp_subtractor_altpriority_encoder_rf8   altpriority_encoder8
	( 
	.data(data[31:16]),
...
endmodule //fp_subtractor_altpriority_encoder_qb6
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_subtractor_altpriority_encoder_nh8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {(~ data[0])},
		zero = (~ (data[0] | data[1]));
endmodule //fp_subtractor_altpriority_encoder_nh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_subtractor_altpriority_encoder_qh8
	( 
	data,
	q,
	zero) ;
	...
	fp_subtractor_altpriority_encoder_nh8   altpriority_encoder27
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder27_q),
	.zero(wire_altpriority_encoder27_zero));
	fp_subtractor_altpriority_encoder_nh8   altpriority_encoder28
	( 
	.data(data[3:2]),
...
endmodule //fp_subtractor_altpriority_encoder_qh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_subtractor_altpriority_encoder_vh8
	( 
	data,
	q,
	zero) ;
	...
	fp_subtractor_altpriority_encoder_qh8   altpriority_encoder25
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder25_q),
	.zero(wire_altpriority_encoder25_zero));
	fp_subtractor_altpriority_encoder_qh8   altpriority_encoder26
	( 
	.data(data[7:4]),
...
endmodule //fp_subtractor_altpriority_encoder_vh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_subtractor_altpriority_encoder_fj8
	( 
	data,
	q,
	zero) ;
	...
	fp_subtractor_altpriority_encoder_vh8   altpriority_encoder23
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder23_q),
	.zero(wire_altpriority_encoder23_zero));
	fp_subtractor_altpriority_encoder_vh8   altpriority_encoder24
	( 
	.data(data[15:8]),
...
endmodule //fp_subtractor_altpriority_encoder_fj8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_subtractor_altpriority_encoder_n28
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {(~ data[0])};
endmodule //fp_subtractor_altpriority_encoder_n28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_subtractor_altpriority_encoder_q28
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	fp_subtractor_altpriority_encoder_nh8   altpriority_encoder33
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder33_q),
	.zero(wire_altpriority_encoder33_zero));
	fp_subtractor_altpriority_encoder_n28   altpriority_encoder34
	( 
	.data(data[3:2]),
...
endmodule //fp_subtractor_altpriority_encoder_q28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_subtractor_altpriority_encoder_v28
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	fp_subtractor_altpriority_encoder_qh8   altpriority_encoder31
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder31_q),
	.zero(wire_altpriority_encoder31_zero));
	fp_subtractor_altpriority_encoder_q28   altpriority_encoder32
	( 
	.data(data[7:4]),
...
endmodule //fp_subtractor_altpriority_encoder_v28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_subtractor_altpriority_encoder_f48
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	fp_subtractor_altpriority_encoder_vh8   altpriority_encoder29
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder29_q),
	.zero(wire_altpriority_encoder29_zero));
	fp_subtractor_altpriority_encoder_v28   altpriority_encoder30
	( 
	.data(data[15:8]),
...
endmodule //fp_subtractor_altpriority_encoder_f48

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_subtractor_altpriority_encoder_e48
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	fp_subtractor_altpriority_encoder_fj8   altpriority_encoder21
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder21_q),
	.zero(wire_altpriority_encoder21_zero));
	fp_subtractor_altpriority_encoder_f48   altpriority_encoder22
	( 
	.data(data[31:16]),
...
endmodule //fp_subtractor_altpriority_encoder_e48

//synthesis_resources = lpm_add_sub 14 lpm_compare 1 reg 282 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_subtractor_altfp_add_sub_61k
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	fp_subtractor_altbarrel_shift_ltd   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fp_subtractor_altbarrel_shift_aeb   rbarrel_shift
	( 
	.data({man_smaller_dffe13_wo, {2{1'b0}}}),
	.distance(rshift_distance_dffe13_wo),
	.result(wire_rbarrel_shift_result));
	fp_subtractor_altpriority_encoder_qb6   leading_zeroes_cnt
	( 
	.data({man_add_sub_res_mag_dffe21_wo[25:1], 1'b1, {6{1'b0}}}),
	.q(wire_leading_zeroes_cnt_q));
	fp_subtractor_altpriority_encoder_e48   trailing_zeros_cnt
	( 
...
endmodule //fp_subtractor_altfp_add_sub_61k
//VALID FILE
...
module fp_subtractor (
	...
	fp_subtractor_altfp_add_sub_61k	fp_subtractor_altfp_add_sub_61k_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
